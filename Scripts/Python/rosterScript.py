# This script is preconfigured to work on Emirates Roster PDF.
# If your roster is different, see the documentation.
# A tutorial on how to use it https://youtu.be/3E1GoA7wCEk
